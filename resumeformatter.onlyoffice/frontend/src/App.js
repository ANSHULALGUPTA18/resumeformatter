...
function App() {
  ...
  const userEmail = userAccount?.username || userAccount?.idTokenClaims?.preferred_username || '';
        ...
        <div className="header-content">
          <div className="header-left">
            <div className="logo-circle">
              <img src="/logoo.png" alt="Resume Formatter Pro" className="logo-image" />
            </div>
          ...
          <div className="header-actions">
            <div className="auth-controls">
              ...
              <button id="logoutBtn" className="logout-button" onClick={handleLogout} title="Sign out">
                Logout
              </button>
            </div>
          </div>
